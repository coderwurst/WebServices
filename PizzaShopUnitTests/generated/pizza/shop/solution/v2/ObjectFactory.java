 ...
 * generated in the pizza.shop.solution.v2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _PlaceOrderForPizza_QNAME = new QName("http://v2.solution.shop.pizza/", "placeOrderForPizza");
    private final static QName _PurchaseYourPizzaResponse_QNAME = new QName("http://v2.solution.shop.pizza/", "purchaseYourPizzaResponse");
    private final static QName _PlaceOrderForPizzaResponse_QNAME = new QName("http://v2.solution.shop.pizza/", "placeOrderForPizzaResponse");
    private final static QName _PurchaseYourPizza_QNAME = new QName("http://v2.solution.shop.pizza/", "purchaseYourPizza");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pizza.shop.solution.v2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://v2.solution.shop.pizza/", name = "placeOrderForPizza")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://v2.solution.shop.pizza/", name = "purchaseYourPizzaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://v2.solution.shop.pizza/", name = "placeOrderForPizzaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://v2.solution.shop.pizza/", name = "purchaseYourPizza")
