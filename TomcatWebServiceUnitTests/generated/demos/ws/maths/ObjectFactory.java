 ...
 * generated in the demos.ws.maths package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://maths.ws.demos/", "add");
    private final static QName _DivideResponse_QNAME = new QName("http://maths.ws.demos/", "divideResponse");
    private final static QName _SubtractResponse_QNAME = new QName("http://maths.ws.demos/", "subtractResponse");
    private final static QName _Divide_QNAME = new QName("http://maths.ws.demos/", "divide");
    private final static QName _Multiply_QNAME = new QName("http://maths.ws.demos/", "multiply");
    private final static QName _MultiplyResponse_QNAME = new QName("http://maths.ws.demos/", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://maths.ws.demos/", "subtract");
    private final static QName _AddResponse_QNAME = new QName("http://maths.ws.demos/", "addResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: demos.ws.maths
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://maths.ws.demos/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://maths.ws.demos/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://maths.ws.demos/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://maths.ws.demos/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://maths.ws.demos/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://maths.ws.demos/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://maths.ws.demos/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://maths.ws.demos/", name = "addResponse")
