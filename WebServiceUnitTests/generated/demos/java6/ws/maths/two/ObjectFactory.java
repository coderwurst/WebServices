 ...
 * generated in the demos.java6.ws.maths.two package. 
...
public class ObjectFactory {
    ...
    private final static QName _Multiplication_QNAME = new QName("http://two.maths.ws.java6.demos/", "multiplication");
    private final static QName _Division_QNAME = new QName("http://two.maths.ws.java6.demos/", "division");
    private final static QName _MultiplicationResponse_QNAME = new QName("http://two.maths.ws.java6.demos/", "multiplicationResponse");
    private final static QName _Subtraction_QNAME = new QName("http://two.maths.ws.java6.demos/", "subtraction");
    private final static QName _Addition_QNAME = new QName("http://two.maths.ws.java6.demos/", "addition");
    private final static QName _DivisionResponse_QNAME = new QName("http://two.maths.ws.java6.demos/", "divisionResponse");
    private final static QName _AdditionResponse_QNAME = new QName("http://two.maths.ws.java6.demos/", "additionResponse");
    private final static QName _SubtractionResponse_QNAME = new QName("http://two.maths.ws.java6.demos/", "subtractionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: demos.java6.ws.maths.two
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://two.maths.ws.java6.demos/", name = "multiplication")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://two.maths.ws.java6.demos/", name = "division")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://two.maths.ws.java6.demos/", name = "multiplicationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://two.maths.ws.java6.demos/", name = "subtraction")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://two.maths.ws.java6.demos/", name = "addition")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://two.maths.ws.java6.demos/", name = "divisionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://two.maths.ws.java6.demos/", name = "additionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://two.maths.ws.java6.demos/", name = "subtractionResponse")
