 ...
 * generated in the demos.java6.ws.maths.one package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://one.maths.ws.java6.demos/", "add");
    private final static QName _DivideResponse_QNAME = new QName("http://one.maths.ws.java6.demos/", "divideResponse");
    private final static QName _SubtractResponse_QNAME = new QName("http://one.maths.ws.java6.demos/", "subtractResponse");
    private final static QName _Divide_QNAME = new QName("http://one.maths.ws.java6.demos/", "divide");
    private final static QName _Multiply_QNAME = new QName("http://one.maths.ws.java6.demos/", "multiply");
    private final static QName _MultiplyResponse_QNAME = new QName("http://one.maths.ws.java6.demos/", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://one.maths.ws.java6.demos/", "subtract");
    private final static QName _AddResponse_QNAME = new QName("http://one.maths.ws.java6.demos/", "addResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: demos.java6.ws.maths.one
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.maths.ws.java6.demos/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.maths.ws.java6.demos/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.maths.ws.java6.demos/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.maths.ws.java6.demos/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.maths.ws.java6.demos/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.maths.ws.java6.demos/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.maths.ws.java6.demos/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.maths.ws.java6.demos/", name = "addResponse")
