 ...
 * generated in the demos.java6.ws.shop.one package. 
...
public class ObjectFactory {
    ...
    private final static QName _IsInStock_QNAME = new QName("http://one.shop.ws.java6.demos/", "isInStock");
    private final static QName _MakePurchase_QNAME = new QName("http://one.shop.ws.java6.demos/", "makePurchase");
    private final static QName _QuantityInStock_QNAME = new QName("http://one.shop.ws.java6.demos/", "quantityInStock");
    private final static QName _GetPriceResponse_QNAME = new QName("http://one.shop.ws.java6.demos/", "getPriceResponse");
    private final static QName _QuantityInStockResponse_QNAME = new QName("http://one.shop.ws.java6.demos/", "quantityInStockResponse");
    private final static QName _GetPrice_QNAME = new QName("http://one.shop.ws.java6.demos/", "getPrice");
    private final static QName _IsInStockResponse_QNAME = new QName("http://one.shop.ws.java6.demos/", "isInStockResponse");
    private final static QName _MakePurchaseResponse_QNAME = new QName("http://one.shop.ws.java6.demos/", "makePurchaseResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: demos.java6.ws.shop.one
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.shop.ws.java6.demos/", name = "isInStock")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.shop.ws.java6.demos/", name = "makePurchase")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.shop.ws.java6.demos/", name = "quantityInStock")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.shop.ws.java6.demos/", name = "getPriceResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.shop.ws.java6.demos/", name = "quantityInStockResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.shop.ws.java6.demos/", name = "getPrice")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.shop.ws.java6.demos/", name = "isInStockResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://one.shop.ws.java6.demos/", name = "makePurchaseResponse")
